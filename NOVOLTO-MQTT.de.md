...
Verzögerung ist normales Geräteverhalten, kein Bug in heatpump-novolto.

| Feld | Typ | Bedeutung | Genutzt in heatpump-novolto |
|---|---|---|---|
...
"gerade tatsächlich Strom fließt" abbildet. heatpump-novolto verwendet daher
...
heatpump-novolto wertet diese Quittungen aktuell **nicht aus** — sie landen auf
...
heatpump-novolto sendet dementsprechend `spp` als Integer, `sptw`/`sptwh`
